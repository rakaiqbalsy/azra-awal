...
class User extends CI_Controller {
	...
	public function create() {
		...
		if ($this->form_validation->run() == false) {
			...
			$this->load->view('templates/panel/nav', $data);
			$this->load->view('templates/panel/sidebar', $data);
			$this->load->view('panel/kelola/user/add', $data);
			$this->load->view('templates/panel/footer');
		}
			...
			redirect('panel/kelola/user/user');
		}
	}
	...
	public function update($id) {
		...
		if ($this->form_validation->run() == false) {
			...
			$this->load->view('panel/kelola/user/update', $data_user);
			$this->load->view('templates/panel/footer');
		}
